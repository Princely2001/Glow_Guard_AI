...
import '../Chemical_expert/Expert_register_screen.dart';
...
class _ExpertLoginScreenState extends State<ExpertLoginScreen>
  ...
  Future<void> _loginExpert() async {
    ...
    try {
      ...
      // Convert auth exceptions into friendly text
      final msg = e.toString();
      if (msg.contains("wrong-password")) {
        _snack("Incorrect password.");
      } else if (msg.contains("user-not-found")) {
        _snack("No expert account found for that email.");
      } else if (msg.contains("invalid-email")) {
        _snack("Please enter a valid email address.");
      } else if (msg.contains("not-expert")) {
        _snack("Access denied: this account is not an expert.");
      } else if (msg.contains("expert-pending")) {
        _snack("Your expert account is pending approval.");
      ...
      body: Stack(
        children: [
          ...
          Positioned(
            top: -120,
            left: -80,
            child: _Blob(color: teal.withOpacity(0.16), size: 260),
          ),
          Positioned(
            bottom: -140,
            right: -90,
            child: _Blob(color: cs.secondary.withOpacity(0.14), size: 320),
          ),
          SafeArea(
            child: Center(
                        ...
                        child: Form(
                          ...
                          child: Column(
                            ...
                            children: [
                              TweenAnimationBuilder<double>(
                                ...
                                builder: (context, t, _) {
                                  ...
                                  return Transform.translate(
                                    offset: Offset(0, dy),
                                    child: const _LogoBadge(icon: Icons.science_outlined),
                                  );
                                },
                              ),
                              const SizedBox(height: 14),
                              const Text(
                                'Chemical Expert Login',
                              ...
                              Text(
                                'Login to access expert tools\nand ingredient safety reports.',
                                textAlign: TextAlign.center,
                              ...
                              GestureDetector(
                                ...
                                child: AnimatedScale(
                                  ...
                                  child: ElevatedButton(
                                    onPressed: _loading ? null : _loginExpert,
                              ...
                              OutlinedButton.icon(
                                onPressed: _loading ? null : _goToExpertRegister,
                                icon: const Icon(Icons.person_add_alt_1_outlined),
                                label: const Text('Register as Chemical Expert'),
